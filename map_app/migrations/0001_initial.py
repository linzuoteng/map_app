    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('男', '男'), ('女', '女'), ('その他', 'その他')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('monster', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='map_app.monsterlist')),
        ...
        migrations.AddConstraint(
            model_name='owner',
            constraint=models.UniqueConstraint(fields=('user', 'monster'), name='unique_user_monster'),
        ),
    ]
